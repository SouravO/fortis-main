...
const projectImages = Object.values(
  import.meta.glob('../data/images/*', { eager: true })
).map((m) => m.default)
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-white/60 max-w-xl leading-relaxed">
              A showcase of our completed work across residential, commercial, hospitality,
              interior fit-out, and renovation sectors.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {projectImages.map((src, i) => (
              <motion.div
                ...
                onClick={() => setLightbox({ images: projectImages, index: i })}
              >
